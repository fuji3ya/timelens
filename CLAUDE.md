...
> **⚠️ 2026-07-05 更新: フェーズ順序と検証方法は [`Docs/PLAN_V2.md`](Docs/PLAN_V2.md) が現行版。**
> 本節（v1）と矛盾する場合は PLAN_V2 を優先する。主な変更: コンテンツ制作を Track C として並走化 / Phase 3 (3D) を P1 降格 / Phase 1.5 (TestFlight パイプライン) 新設 / Phase 2.5 実機体験ゲート新設。仕様・ルール（§1〜§9, §11〜§17）は引き続き本文書が一次情報。
